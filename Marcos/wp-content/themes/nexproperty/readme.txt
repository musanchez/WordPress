...
Real Estate Directory Theme for Real Estate Agency, Realtor, Broker, Classified Ads, Apartments and will help you to run any type of Classified Directory or Listings Business.

== Description ==

Listing Directory theme for Real Estate Agency, Realtor, Apartment, includes also Car Dealer demo content but will help you to run any type of Directory Business.

Theme is mostly build for Elementor so everything can be customized visually.

<h3>Real Estate Agency Directory Features</h3>
<ul>
...
Theme works perfectly and by default use Elementor, WpDirectoryKit, ElementInvader, ElementInvader Addons

== Changelog ==

= 1.2.0 - June 06 2023 =
* Demo content import improvements
...
= 1.1.7 - February 11 2023 =
* Elementor compatibility fixes

= 1.1.5 - November 24 2022 =
* menu layout improvements

= 1.1.4 - November 10 2022 =
* Plugins compatibility

= 1.1.2 - June 23 2022 =
* Webfont loader implemented

= 1.1.1 - June 06 2022 =
* New wp compatibility, small fixes

= 1.1.0 - May 07 2022 =
* Improvements on layouts
* Improvements on mobile menu keyboard navigation

= 1.0.9 - April 29 2022 =
* Child theme support
* Improvements on layouts
* New plugins updates and many new addons support
...
* Plugin for Real Estate Directory Integration
