jQuery(function ($) {
    $('.real-estate-dark-house-install-plugin').on('click', function (event) {
    ...
    $(document).on('click', '.real-estate-dark-house-activate-plugin', function (event) {
        event.preventDefault();
        var $button = $(this);
        $button.addClass('updating-message').html( );

        real_estate_dark_house_activate_plugin($button);
    ...
    $(document).on('wp-plugin-installing', function (event, args) {
        ...
        $('.real-estate-dark-house-install-plugin').addClass('updating-message').html(importer_params.installing_text);
    ...
    $(document).on('wp-plugin-install-success', function (event, response) {
        ...
        event.preventDefault();
        var $button = $('.real-estate-dark-house-install-plugin');
    ...
    function real_estate_dark_house_activate_plugin($button) {
        $.ajax({
            url: ajaxurl,
            type: 'POST',
            data: {
                action: 'real_estate_dark_house_activate_plugin',
                slug: $button.data('slug'),
