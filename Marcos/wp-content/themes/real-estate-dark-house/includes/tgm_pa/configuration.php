 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme real-estate-dark-house
...
add_action( 'tgmpa_register', 'real_estate_dark_house_register_required_plugins' );
 ...
 */
function real_estate_dark_house_register_required_plugins() {
	/*
	...
	$config = array(
		'id'           => 'real-estate-dark-house',                 // Unique ID for hashing notices for multiple instances of TGMPA.
